...
$string['ubrevealjsname'] = 'Course name';
/*
$string['ubrevealjsjson'] = 'json content of the initial circuit';
$string['ubrevealjsjson_help'] = 'A valid description of the initial circuit should be provided in json format. 
<pre>
</pre>';
*/
